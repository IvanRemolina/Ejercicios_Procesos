...
public class GestorConsultas {
    ...
    private void creaFichero(String nombreFichero) {
        try {
            ...
            if ( ! exists) {
                System.out.println("Creando discos por defecto...");
    ...
    private void creaDiscosPorDefecto() {
        Disco disco1 = new Disco(1, "Que voy a hacer", "Los Planetas", 5, 20.0);
        disco1.escribeEnFichero(stream);
        Disco disco2 = new Disco(2, "La voz del presidente", "Viva Suecia", 1, 35.0);
        disco2.escribeEnFichero(stream);
        Disco disco3 = new Disco(3, "La revolución sexual", "La casa azul", 10, 20.0);
        disco3.escribeEnFichero(stream);
        Disco disco4 = new Disco(4, "Finisterre", "Vetusta Morla", 5, 40.0);
        disco4.escribeEnFichero(stream);
        Disco disco5 = new Disco(5, "Paradise","Coldplay", 2, 35.0);
    ...
    private long buscaCodigo(int codigoBuscado) {
        ...
        do
        {
            try {
                ...
                System.out.println("Codigo de disco no existente");
    ...
    public String[] buscaAutor(String autorBuscado) {
        ...
        while(true)
        {
            try {
                ...
                System.out.println("No existe este autor/grupo");
                break;
            } catch (IOException e) {
                System.out.println("Error leyendo del fichero");
                System.exit(0);
